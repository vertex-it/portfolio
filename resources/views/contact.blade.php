        ...
        <div class="bg-gray-50">
            <div class="py-12 md:py-20 lg:py-24">
                <div class="app-container relative z-10">
                    ...
                    <p class="mt-6 text-sm md:text-base lg:text-lg text-gray-500 max-w-3xl">Ready to kickstart your next project? Contact us today and let's turn your vision into reality.</p>
                </div>
            </div>
        </div>
            ...
            <div class="app-container">
                <div class="relative bg-white shadow-xl">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3">
                        <!-- Contact information -->
                        <div class="relative overflow-hidden py-10 px-6 bg-gradient-to-b from-red-500 to-red-600 sm:px-10 xl:p-12">
                            ...
                            <p class="mt-6 text-xs sm:text-sm md:text-base text-red-50 max-w-3xl">
                                You can reach us anytime through our contact form or by emailing us, and we’ll get back to you as soon as possible.
                            </p>
                            <a href="mailto:office@vertex-it.com">
                                <dl class="mt-8 space-y-6">
                                    ...
                                    <dd class="flex text-base text-red-50">
                                        ...
                                        <span class="ml-3">office@vertex-it.com</span>
                                    </dd>
                                </dl>
                            </a>
...
{{--                                </li>--}}
{{--                                <li>--}}
{{--                                    <a class="flex text-red-200 hover:text-red-100" href="https://github.com/vertex-it" target="_blank">--}}
{{--                                        <svg class="w-7 h-7" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">--}}
...
{{--                                        </svg>--}}
{{--                                        <span class="ml-3 text-red-50">GitHub</span>--}}
{{--                                    </a>--}}
{{--                                </li>--}}
{{--                                <li>--}}
{{--                                    <a class="text-red-200 hover:text-red-100" href="#">--}}
...
{{--                                </li>--}}
                        ...
                        <div class="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
                            ...
                            <form action="{{ route('sendMail') }}" method="POST" class="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                                @csrf
                                <div>
